...
Shader "shd_rat_part1 1"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_GJ_Rat_low_Rat_Body_BaseColor("GJ_Rat_low_Rat_Body_BaseColor", 2D) = "white" {}
		_GJ_Rat_low_Rat_Body_Normal("GJ_Rat_low_Rat_Body_Normal", 2D) = "bump" {}
		[ASEEnd]_GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic("GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _GJ_Rat_low_Rat_Body_BaseColor_ST;
			float4 _GJ_Rat_low_Rat_Body_Normal_ST;
			float4 _GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic_ST;
			...
			#endif
			CBUFFER_END
			sampler2D _GJ_Rat_low_Rat_Body_BaseColor;
			sampler2D _GJ_Rat_low_Rat_Body_Normal;
			sampler2D _GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_GJ_Rat_low_Rat_Body_BaseColor = IN.ase_texcoord7.xy * _GJ_Rat_low_Rat_Body_BaseColor_ST.xy + _GJ_Rat_low_Rat_Body_BaseColor_ST.zw;
				
				float2 uv_GJ_Rat_low_Rat_Body_Normal = IN.ase_texcoord7.xy * _GJ_Rat_low_Rat_Body_Normal_ST.xy + _GJ_Rat_low_Rat_Body_Normal_ST.zw;
				
				float2 uv_GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic = IN.ase_texcoord7.xy * _GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic_ST.xy + _GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic_ST.zw;
				float4 tex2DNode12 = tex2D( _GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic, uv_GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic );
				
				float3 Albedo = tex2D( _GJ_Rat_low_Rat_Body_BaseColor, uv_GJ_Rat_low_Rat_Body_BaseColor ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _GJ_Rat_low_Rat_Body_Normal, uv_GJ_Rat_low_Rat_Body_Normal ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_GJ_Rat_low_Rat_Body_BaseColor = IN.ase_texcoord2.xy * _GJ_Rat_low_Rat_Body_BaseColor_ST.xy + _GJ_Rat_low_Rat_Body_BaseColor_ST.zw;
...
/*ASEBEGIN
Version=18800
0;0;1920;1019;1305.472;550.66;1.3;True;True
Node;AmplifyShaderEditor.SamplerNode;8;-441.0553,-48.63061;Inherit;True;Property;_GJ_Rat_low_Rat_Body_BaseColor;GJ_Rat_low_Rat_Body_BaseColor;0;0;Create;True;0;0;0;False;0;False;-1;882a792d1704c8842b78422461f9a40c;882a792d1704c8842b78422461f9a40c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-443.5717,381.4403;Inherit;True;Property;_GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic;GJ_Rat_low_Rat_Body_OcclusionRoughnessMetallic;2;0;Create;True;0;0;0;False;0;False;-1;8bc09eb37e8f5f84b9638279e1c1cc6b;8bc09eb37e8f5f84b9638279e1c1cc6b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-427.9718,163.0398;Inherit;True;Property;_GJ_Rat_low_Rat_Body_Normal;GJ_Rat_low_Rat_Body_Normal;1;0;Create;True;0;0;0;False;0;False;-1;adc64a92d240cda42b68c664f17e036b;adc64a92d240cda42b68c664f17e036b;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;13;-96.47175,295.6402;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;65,52;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;shd_rat_part1 1;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=32BD245E7301BBDCF563B430E6815BF53F0BCA6C